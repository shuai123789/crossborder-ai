...
skills_text = '''AI/LLM：Prompt Engineering、RAG检索增强生成、Multi-Agent架构（ReAct）、DeepSeek API、ChromaDB
后端：Python、Java、FastAPI、SpringBoot、MySQL、Kafka、Linux
前端：React、TailwindCSS、Git、Docker
证书：Java软件开发工程师（工信人才）| OceanBase OBCA'''
...
# Save document
output_path = r'C:\Users\qiao\Downloads\率乔_简历_AI工程师_一页版.docx'
